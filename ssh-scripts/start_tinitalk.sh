...
ExecStart=/usr/local/bin/tinitalk serve --data-dir /var/lib/tinitalk --addr :443 --tls-cert /var/lib/tinitalk/tls/fullchain.pem --tls-key /var/lib/tinitalk/tls/privkey.pem --turn-public-host $server_address --turn-public-ip $public_ipv4 --turn-addr :3478 --turn-tls-addr :5349 --turn-udp-read-buffer 4194304
Restart=always
RestartSec=3
LimitNOFILE=4096
